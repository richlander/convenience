...
public static class Utf8JsonReaderWriterBenchmark
{
    public static async Task<string> Run()
    {
        ...
        memory.Flush();
        memory.Position= 0;
        StreamReader reader = new(memory);
...
public class ReleaseJsonWriter(ReleasesJsonReader releasesReader, Stream memory)
{
    ...
    public void WriteReleasesProperty()
    {
...
{
    private const string BADJSON = "JSON data is missing.";
    private const string BADJSONREAD = "Cannot read JSON data.";
    ...
    public Version GetVersion()
    {
        ...
        throw new Exception(BADJSONREAD);
    }
